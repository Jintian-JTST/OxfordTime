...
\title{Measurement of the Rydberg Constant from the Hydrogen Balmer Spectrum} %Title should be concise and to the point  
...
From sections 4.2 and 4.3, we can see that the experimental value of the Rydberg constant is in excellent agreement with theoretical predictions. However, the experimental value is slightly higher ($\sim 0.08\%$) than the theoretical $R_{\mathrm{H}}$, making it appear closer to $R_\infty$. We suggest that this small discrepancy  is predominantly driven by systematic errors in the experiment.
